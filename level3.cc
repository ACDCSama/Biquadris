...
Level3::Level3(int seed, std::vector<char> sequence, bool isRandom)
    :Level{3}, seed{seed}, sequence{sequence}, isRandom{isRandom}{}

std::shared_ptr<Block> Level3::genBlock(){
    if (!isRandom) {
